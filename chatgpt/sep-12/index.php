...
<table>
    ...
    <tbody>
        ...
        foreach ($data as $row) {
            ...
            file_put_contents('error_log.log', "Before sorting: " . json_encode($imgPaths) . "\n", FILE_APPEND);
            
            // Log the imageOrder array
            file_put_contents('image_order_log.txt', "Image Order:\n" . print_r($imageOrder, true) . "\n", FILE_APPEND);
            
            // Log the imgPaths array
            file_put_contents('img_paths_log.txt', "Image Paths:\n" . print_r($imgPaths, true) . "\n", FILE_APPEND);
            ...
            usort($imgPaths, function($a, $b) use ($imageOrder) {
              ...
              // Log the comparisons
                file_put_contents('error_log.log', "Comparing: $aName ($aPosition) vs $bName ($bPosition)\n", FILE_APPEND);
            ...
            file_put_contents('error_log.log', "After sorting: " . json_encode($imgPaths) . "\n", FILE_APPEND);
